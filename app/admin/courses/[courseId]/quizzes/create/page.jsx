// app/admin/courses/[courseId]/quizzes/create/page.jsx
'use client';
...
import { 
  ...
  GripVertical, CheckSquare, FileText, AlertCircle
} from 'lucide-react';
...
export default function CreateQuizPage() {
  ...
  const fetchModules = async () => {
    try {
      const response = await authClient.fetchWithAuth(`/api/admin/courses/${courseId}/modules`);
    ...
    <div className="min-h-screen bg-background py-8 px-4 sm:px-6 lg:px-8 mt-24">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-4xl font-black text-foreground mb-2">Create New Quiz</h1>
          <p className="text-foreground/60">Design a quiz for your course students</p>
        </div>
